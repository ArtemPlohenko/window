  ...
  function bindActionToElems(event, elem, prop) {
    elem.forEach((item, i) => {
      item.addEventListener(event, () => {
        ...
        /* eslint-disable */
        console.log(...oo_oo(`181493912_38_8_38_26_4`, state));
      });
    });
  }
  ...
  form.forEach(item => {
    item.addEventListener("submit", e => {
      ...
      postData("assets/server.php", formData).then(res => {
        /* eslint-disable */console.log(...oo_oo(`3518226609_48_10_48_26_4`, res));
